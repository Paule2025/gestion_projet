                    ...
                    <div className='md:w-3/4 mt-4 md:mt-0 md:ml-4'>
                        <div className='flex flex-col justify-between w-full'>
                            <input
                                ...
                                className='w-full input input-bordered border border-base-300 mb-4 font-bold'
                                type="text"
                                value={name}
                                onChange={(e) => setName(e.target.value)} />

                            <ReactQuill placeholder='Decrivez votre projet '
                                modules={modules}
                                value={description}
                       ...
                       <button className='btn btn-md btn-primary mt-4' onClick={handleSubmit}>Créer la tâche</button>
                       </div>
                    </div>
                </div>
            </div>
